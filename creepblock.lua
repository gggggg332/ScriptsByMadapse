...
local key = Menu.AddKeyOption({"Script By Madaspe", "CreepBlock"}, "KeyToBlock", Enum.ButtonCode.KEY_SPACE)
Blocker.skipRangedCreep = Menu.AddOptionBool({ "Script By Madaspe", "CreepBlock" , "Skip ranged creep" }, "Enabled", "Bot will try to skip ranged creep.")

...
local optionTornadoCombo = Menu.AddOptionBool({"ScriptsByMadaspe", "Invoker By Madapse"}, "Eul/Tornado Combo", "Auto cast ice wall, chaos meteor, sun strike, EMP with eul/tornado")
local optionFixedPositionCombo = Menu.AddOptionBool({"ScriptsByMadaspe", "Invoker By Madapse"}, "Fixed Position Combo", "Auto cast sun strike, chaos meteor, EMP on stunned/rooted/taunted enemy if possible")
local optionInstanceHelper = Menu.AddOptionBool({"ScriptsByMadaspe", "Invoker By Madapse"}, "Instance Helper", "auto switch instances, EEE when attacking, WWW when running")
local optionKillSteal = Menu.AddOptionBool({"ScriptsByMadaspe", "Invoker By Madapse"}, "Kill Steal", "auto cast deafening blast, tornado or sun strike to predicted position to KS")
local optionInterrupt = Menu.AddOptionBool({"ScriptsByMadaspe", "Invoker By Madapse"}, "Interrupt", "Auto interrupt enemy's tp or channelling spell with tornado or cold snap")
local optionSpellProtection = Menu.AddOptionBool({"ScriptsByMadaspe", "Invoker By Madapse"}, "Spell Protection", "Protect uncast spell by moving casted spell to second slot")
